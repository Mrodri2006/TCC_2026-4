...
export default function Register() {
  ...
  const tiposProfissao = [
    ...
    { id: 6, nome: 'Pedreiro' },
    { id: 7, nome: 'Pintor' },
    { id: 8, nome: 'Marceneiro' },
    { id: 9, nome: 'Serralheiro' },
    { id: 10, nome: 'Gesseiro' },
    { id: 11, nome: 'Carpinteiro' },
    { id: 12, nome: 'Vidraceiro' },
    { id: 13, nome: 'Chaveiro' },
    { id: 14, nome: 'Técnico de Ar-Condicionado' },
    { id: 15, nome: 'Técnico de Eletrodomésticos' },
    { id: 16, nome: 'Técnico de Informática' },
    { id: 17, nome: 'Instalação de Câmeras' },
    { id: 18, nome: 'Instalação de Internet e Redes' },
    { id: 19, nome: 'Limpeza de Piscina' },
    { id: 20, nome: 'Limpeza de Estofados' },
    { id: 21, nome: 'Lavagem de Automóveis' },
    { id: 22, nome: 'Dedetização' },
    { id: 23, nome: 'Mudanças e Fretes' },
    { id: 24, nome: 'Cuidador de Idosos' },
    { id: 25, nome: 'Babá' },
    { id: 26, nome: 'Passeador de Cães' },
    { id: 27, nome: 'Manutenção Residencial' },
    { id: 28, nome: 'Instalação de Pisos e Revestimentos' },
    { id: 29, nome: 'Reparo de Telhados' },
    { id: 30, nome: 'Energia Solar' },
  ];
                ...
                <View style={styles.modalCard}>
                  ...
                  <View style={styles.modalContent}>
                    ...
                    <TouchableOpacity style={styles.openPdfButton} onPress={abrirPdfExterno} disabled={pdfCarregando} activeOpacity={0.85}>
                      {pdfCarregando ? <ActivityIndicator color="#071A33" /> : <Text style={styles.openPdfButtonText}>Abrir PDF</Text>}
                    </TouchableOpacity>
                  </View>

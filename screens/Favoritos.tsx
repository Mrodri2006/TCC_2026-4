...
const styles = StyleSheet.create({ screen: { flex: 1 }, header: { paddingTop: 55, paddingBottom: 16, paddingHorizontal: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottomWidth: 1 }, title: { fontSize: 20, fontWeight: "900" }, list: { padding: 16, flexGrow: 1 }, card: { flexDirection: "row", alignItems: "center", gap: 12, padding: 16, marginBottom: 12, borderRadius: 18, borderWidth: 1 }, name: { fontSize: 16, fontWeight: "900" }, rating: { color: "#B45309", marginTop: 6 }, hire: { flexDirection: "row", gap: 5, backgroundColor: "#2563EB", paddingHorizontal: 10, paddingVertical: 9, borderRadius: 12 }, hireText: { color: "#FFFFFF", fontSize: 11, fontWeight: "800" }, skeletons: { padding: 16, gap: 12 }, skeleton: { height: 96, borderRadius: 18 } });
